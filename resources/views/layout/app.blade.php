...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fontend') }}/assets/css/ticker-style.css">
...
<body>
                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li><img src="{{ asset('fontend') }}/assets/img/icon/header_icon1.png"
                                                alt="">34ºc, Sunny </li>
                                        <li><img src="{{ asset('fontend') }}/assets/img/icon/header_icon1.png"
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="{{ route('home') }}"><img src="{{ asset('fontend') }}/assets/img/logo/logo.png"
                                            alt=""></a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                                ...
                                <div class="sticky-logo">
                                    <a href="index.html"><img src="{{ asset('fontend') }}/assets/img/logo/logo.png"
                                            alt=""></a>
                                </div>
                                <!-- Main-menu -->
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            ...
                            <div class="instagram-gellay">
                                <ul class="insta-feed">
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra1.jpg" alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra2.jpg" alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra3.jpg" alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra4.jpg" alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra5.jpg" alt=""></a>
                                    </li>
                                    <li><a href="#"><img src="{{ asset('fontend') }}/assets/img/post/instra6.jpg" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- Date Picker -->
    <script src="{{ asset('fontend') }}/assets/js/gijgo.min.js"></script>
    ...
    <script src="{{ asset('fontend') }}/assets/js/jquery.ticker.js"></script>
    <script src="{{ asset('fontend') }}/assets/js/site.js"></script>
