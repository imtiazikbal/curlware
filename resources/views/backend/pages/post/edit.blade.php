    ...
    <section class="mt-md-4 pt-md-3">
                        ...
                        <div class="col">
                            <div class="row shadow-sm text-muted">
                                ...
                                <div class="ml-auto mr-3">
                                    <a href="{{ route('posts') }}" class="btn btn-sm btn-info px-3 rounded-0">Todays
                                        Blogs</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="form-group ">
                                            ...
                                            <textarea name="content" id="summernote" class="tinymce form-control rounded-0" style="font-size:30px;" rows="10">
                                              {{ $post->content }}
                                            </textarea> 
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group">
                                        <div class="col text-center pt-5">
                                            ...
                                            <img id="thumbnil" src="{{ asset($post->image) }}" width="200"
                                ...
                                <div class="row mb-5">
                                    <div class="col text-right">
                                        <button type="button" onclick="submitToDraft()"
                                            class="btn btn-block btn-success py-4 shadow">Update</button>
        ...
        <script>
            function submitToDraft() {
                ...
                document.getElementById('save-form').action = "{{ route('posts.update', $post->id) }}";
                // Submit the form
