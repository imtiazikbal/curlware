...
function setupTinyMCE() {
    $('textarea.tinymce').tinymce({
        ...
        // Theme options
        theme_advanced_buttons1: "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,formatselect,fontselect,fontsizeselect,|, forecolor,backcolor,image,|,undo,redo,|,cut,copy,paste,pastetext,pasteword,|,link,unlink,anchor,cleanup,help,code,|,insertdate,inserttime,preview,",
        theme_advanced_buttons2: "forecolor,backcolor,image,|,undo,redo,|,cut,copy,paste,pastetext,pasteword,|,link,unlink,anchor,cleanup,help,code,|,insertdate,inserttime,preview,",
...
function setupTinyMCE1() {
    $('textarea.tinymce').tinymce({
        ...
        //theme_advanced_buttons3: "tablecontrols,|,hr,removeformat,|,print,|,ltr,rtl,|,fullscreen",
        //theme_advanced_buttons4: "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak",
        theme_advanced_toolbar_location: "top",
        theme_advanced_toolbar_align: "left",
        theme_advanced_statusbar_location: "bottom",
